...
#ifndef __CharArray__CharArray
#define __CharArray__CharArray
...
/// const char elements limited only by the amount of
/// memory available in the host process and provides
/// access to stored const char elements via index
...
///////////////////////////////////////////////////////////
   ...
   virtual char const &at(size_t index) const = 0;
...
////////////////////////////////////////////////////////////////////////////////
   ...
   ////////////////////////////////////////////////////////
   /// Appends all CharArray elements in a CharArray
   /// to array expanding storage for array as necessary
   void append(CharArray &);
   ...
   ////////////////////////////////////////////////////////
   /// Print all characters in array to stream
   void print(
      std::ostream &stream = std::cout) const;
   
   ////////////////////////////////////////////////////////
   /// Appends count characters in a C string to array
   /// expanding storage for array as necessary
   void append(const char *aString,
      const size_t count);
};

#endif /* defined(__CharArrayy__CharArray__) */
